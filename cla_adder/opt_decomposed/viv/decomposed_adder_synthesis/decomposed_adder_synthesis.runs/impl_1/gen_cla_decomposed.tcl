...
set rc [catch {
  ...
  set_property webtalk.parent_dir /user/erasmus/danielrb/Dropbox/Tesi/cla_adder/opt_decomposed/viv/decomposed_adder_synthesis/decomposed_adder_synthesis.cache/wt [current_project]
  set_property parent.project_path /user/erasmus/danielrb/Dropbox/Tesi/cla_adder/opt_decomposed/viv/decomposed_adder_synthesis/decomposed_adder_synthesis.xpr [current_project]
  set_property ip_repo_paths /user/erasmus/danielrb/Dropbox/Tesi/cla_adder/opt_decomposed/viv/decomposed_adder_synthesis/decomposed_adder_synthesis.cache/ip [current_project]
  set_property ip_output_repo /user/erasmus/danielrb/Dropbox/Tesi/cla_adder/opt_decomposed/viv/decomposed_adder_synthesis/decomposed_adder_synthesis.cache/ip [current_project]
  add_files -quiet /user/erasmus/danielrb/Dropbox/Tesi/cla_adder/opt_decomposed/viv/decomposed_adder_synthesis/decomposed_adder_synthesis.runs/synth_1/gen_cla_decomposed.dcp
